...
-DCMAKE_MODULE_PATH="/wqy/seeta_sdk/sdk/sdk6.0/common/faceboxes/cmake;/wqy/seeta_sdk/sdk/sdk6.0/common/seetaauthorize/cmake;/wqy/seeta_sdk/sdk/sdk6.0/common/tensorstack/cmake" \
